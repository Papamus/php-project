...
if (isset($_GET["updateUser"])){
    if ($_GET["updateUser"] == 0){
      echo "<h4>Nie udało się zedytowac użytkownika!</h4>";
    }else{
      echo "<h4>Zedytowano użytkownika</h4>";
    }
...
<table>
	...
	if ($result->num_rows == 0){
      ...
      <tr>
        ...
        <td><a href="./5_db_table_delete_update.php?userUpdateId=$user[userId]">Edytuj</a></td>
      </tr>
TABLEUSERS;
		}
	}
...
ADDUSERFORM;
    ...
    echo '<a href="./5_db_table_delete_update.php?showFormAddUser=1">Dodaj użytkownika</a>';
  }
